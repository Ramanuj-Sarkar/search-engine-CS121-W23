...
4. Once N/n has been pressed, the average time of all of the searches will be printed out.
...
2. There is a white box in which queries can be typed. In order to enter a query, press the button to the right which says "Enter Query". Pressing enter on the keyboard does not work in the local GUI.
3. The results will appear at the bottom of the GUI. In order to find other results, repeat Step 2. To stop searching using the local GUI, press "X" on it.
